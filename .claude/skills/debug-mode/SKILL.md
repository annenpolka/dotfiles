...
Choose based on environment. See [references/instrumentation.md](references/instrumentation.md) for all patterns.
...
See [references/instrumentation.md](references/instrumentation.md) for language-specific templates.
...
- [references/instrumentation.md](references/instrumentation.md) - Language-specific instrumentation patterns
